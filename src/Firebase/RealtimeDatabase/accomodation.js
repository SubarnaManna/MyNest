...
export let writeUserData = async (
  // Obj
  OwnerUserId,
  OwnerName,
  OwnerEmail,
  ...
  ImageUrl,
  Rent )=>{
    // await set(ref(database, 'OwnerInformationTable/' + Obj.OwnerUserId + "&" + Obj.AdhaarNumber.toString()), 
    await set(ref(database, 'OwnerInformationTable/' + OwnerUserId + "&" + AdhaarNumber.toString()), 
